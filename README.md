...
**Step 3.** Import required React Bootstrap components within ```Board.js``` file or your custom component files.
...
Now you are ready to use the imported React Bootstrap components within your component hierarchy defined in the render method. Here is an example [Board.js](https://github.com/manavsehgal/react-eshop/blob/master/src/Board.js) redone using React Bootstrap.
